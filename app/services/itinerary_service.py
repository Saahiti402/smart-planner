...
def generate_itinerary(
    ...
    context_hint = (
        f"Recommended based on guide: {destination_context[:300]}"
    ...
    for day in range(1, total_days + 1):
        itinerary[f"day_{day}"] = {
            ...
            "afternoon": f"Enjoy local cuisine and sightseeing in {destination}",
            "evening": f"Relax and explore nightlife / shopping in {destination}"
        }
